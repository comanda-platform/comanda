...
using Comanda.Client.Kitchen.Infrastructure.Notifications;
...
public static class MauiProgram
{
    public static MauiApp CreateMauiApp()
    {
        ...
        builder.Services.AddSingleton<ProductionStateService>();
        builder.Services.AddSingleton<FulfillmentStateService>();
        builder.Services.AddSingleton<AvailabilityStateService>();
